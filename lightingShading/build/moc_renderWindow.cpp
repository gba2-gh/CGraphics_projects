...
#include "../CGraphics_projects/lightingShading/renderWindow.h"
...
QT_MOC_LITERAL(1, 13, 11), // "setPenColor"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5) // "color"

    },
    "renderWindow\0setPenColor\0\0color"
};
...
void renderWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setPenColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
    }
}
